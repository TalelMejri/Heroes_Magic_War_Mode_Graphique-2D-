     ...
     font1 = TTF_OpenFont("Aloevera-OVoWO.ttf",24);
      font2 = TTF_OpenFont("Aloevera-OVoWO.ttf",24);
        ...
        SDL_BlitSurface(menu, NULL, ecran, &positionMenu);
            char* ch_congrat[80];
            sprintf(ch_congrat,"Un trésor de montant << %d >> a été ajouté ",tresor_montant);
...
void congrat_exp(SDL_Surface* ecran,int exp_montant){
    ...
    TTF_Init();
      ...
      font2 = TTF_OpenFont("Aloevera-OVoWO.ttf",24);
        ...
        SDL_BlitSurface(menu, NULL, ecran, &positionMenu);
            char* ch_congrat[80];
            sprintf(ch_congrat,"<< %d >> points d'experience a été ajouté à votre héro principal",exp_montant);
            char ch_congrat_suiv[40]="a héro principal !";
                char* ch1[50];
   ...
   int nombre_phrase=2;
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            ...
            char ch1[50]="Confirmez vous l'ajout de points d'éxperinece ?";
            sprintf(ch,"%d",x);
            phrase[0]= "OUI";
            phrase[1]= "NON";
          int i, y_depart=488;
...
int unitesJoueurs[NB_LIGNES_UNITESJOUEURS][NB_COLONNES_UNITESJOUEURS]){
    ...
    while (continuer==1)
    {
        ...
        SDL_BlitSurface(menu, NULL, ecran, &positionMenu);
            ...
            char* ch[50];
            int x=carte[ligne][colonne]/100;
            char ch1[50]="Confirmez vous l'ajout de piéce d'or ?";
            sprintf(ch,"%d",x);
            phrase[0]= "OUI";
            phrase[1]= "NON";
            int i, y_depart=488;
     ...
     unite23 = IMG_Load("images/unite__23.png");
         char* tous_unites[liste_unite];
            ...
            int sante_enemie=unitesBataille[indice_enemie][SANTE_UNITAIRE_UB];
                 ...
                 char *ch[50];
                 sprintf(ch,"l'unité %d ",num_unite);
                 ...
                 char *ch1[50];
                 if(contre==0){
                 sprintf(ch1,"attaque l'unité %d ",numero_unite_enemie);
                 }else{
     ...
     unite23 = IMG_Load("images/unite__23.png");
         char* tous_unites[liste_unite];
            ...
            int sante_enemie=unitesBataille[indice_enemie][SANTE_UNITAIRE_UB];
                 ...
                 char *ch[50];
                 sprintf(ch,"l'unité ennemie  %d ",num_unite);
                 texte = TTF_RenderText_Blended(font,ch,blanc);
                 positionText.x =195;
                 positionText.y =30;
                 SDL_BlitSurface(texte, NULL, ec, &positionText);
                 ...
                 sprintf(ch1,"contre attaque l'unité %d ",numero_unite_enemie);
                 }
                 texte = TTF_RenderText_Blended(font,ch1,blanc);
                 positionText.x =410;
                 positionText.y =30;
...
int unitesBataille[NB_LIGNES_UNITESBATAILLE][NB_COLONNES_UNITESBATAILLE],int nbr_tour,int type)
{
    ...
    SDL_BlitSurface(menu, NULL, ec, &positionMenu);
            ...
            positionText.y =410;
            SDL_BlitSurface(texte, NULL, ec, &positionText);
            char ch0[50]="cliquer droite sur l'unité ";
                ...
                int indice_i=(y_clicked/50);
                 ...
                 if(indice_unite_battaile!=-1 && plateauBataille[indice_i][indice_j]/100%10==numJoueur){
                  if(unitesBataille[indice_unite_battaile][FINTOUR_UB]==0){
                    char *ch1[50];
                    sprintf(ch1,"selection de l'unité %d",num_unite);
                    texte = TTF_RenderText_Blended(font,ch1,blanc);
                    positionText.x=615;
                    positionText.y=240;
                    SDL_BlitSurface(texte, NULL, ec, &positionText);
                    ...
                    char *ch2[50];
                    sprintf(ch2,"<< cette unité peut ");
                    texte = TTF_RenderText_Blended(font,ch2,yellow);
                    positionText.x=615;
                    positionText.y=260;
                    SDL_BlitSurface(texte, NULL, ec, &positionText);
                    char *ch22[50];
                    sprintf(ch22,"attaquer à distance >>");
                    ...
                    char *ch3[50];
                    sprintf(ch3,"<< cette unité ne peut");
                    texte = TTF_RenderText_Blended(font,ch3,yellow);
                    positionText.x=615;
                    positionText.y=260;
                    SDL_BlitSurface(texte, NULL, ec, &positionText);
                    char *ch33[50];
                    sprintf(ch33,"pas attaquer à distance>>");
                   ...
                   afficherPlateauBataille(ec,JOUEUR_HUMAIN,numJoueurEnnemi,plateauBataille,unitesBataille,type);
                    ...
                    afficherPlateauBataille(ec,JOUEUR_HUMAIN,numJoueurEnnemi,plateauBataille,unitesBataille);
                       ...
                       if(DoubleClickDetected() == 1){
                        ...
                        char *ch4[50];
                        sprintf(ch4,"l'unité:%d deplace à (%d,%d)",num_unite,nouvelle_ligne,nouvelle_colonne);
                        texte = TTF_RenderText_Blended(font,ch4,blanc);
                        positionText.x=613;
                        positionText.y=240;
                        SDL_BlitSurface(texte, NULL, ec, &positionText);
                       afficherPlateauBataille(ec,JOUEUR_HUMAIN,numJoueurEnnemi,plateauBataille,unitesBataille,type);
                        ...
                        if(codeattaque>0){
                            ...
                            if(uniteAttaquable(codeattaque,ligne_unite,colonne_unite,ligne_unite_attaquant,colonne_unite_attaquant)==1){
                                char *ch5[50];
                                sprintf(ch5,"l'unité %d attaque  ",num_unite);
                                texte = TTF_RenderText_Blended(font,ch5,blanc);
                                positionText.x=620;
                                positionText.y=240;
                                SDL_BlitSurface(texte, NULL, ec, &positionText);
                                char *ch55[50];
                                sprintf(ch55,"l'unité %d ",numero_unite_enemie);
...
int jouerTourEnnemiBataille (SDL_Surface *ec, int numJoueur, int numJoueurEnnemi,
    ...
    while((continuer) && (verifier_gagnant==-1) && (verifier_fintour==0)){
        ...
        char *ch[50];
        sprintf(ch,"selection de l'unité %d",num_unite_attaque);
        texte = TTF_RenderText_Blended(font,ch,blanc);
        positionText.x=615;
        positionText.y=240;
        SDL_BlitSurface(texte, NULL, ec, &positionText);
        ...
        indice_unite_attaquante=chercherIndiceAvecDeuxConditions(NUM_JOUEUR_UB,numJoueurEnnemi,NUM_UNITE_UB,num_unite_attaquante,NB_LIGNES_UNITESBATAILLE,NB_COLONNES_UNITESBATAILLE,unitesBataille);
          if(codeattaque==0){
                ...
                SDL_BlitSurface(texte, NULL, ec, &positionText);
                    char *ch1[50];
                    sprintf(ch1,"l'unité %d deplace ",num_unite_attaque);
                    texte = TTF_RenderText_Blended(font,ch1,blanc);
                    positionText.x=615;
                    positionText.y=240;
                    SDL_BlitSurface(texte, NULL, ec, &positionText);
                    ...
                    if(verifier==1 && indice_enemi!=-1){
                      ...
                      int contre=0;
                       afficherPlateauBataille(ec,numJoueurEnnemi,numJoueur,plateauBataille,unitesBataille,type);
                        SDL_BlitSurface(menu, NULL, ec, &positionMenu);
                        char *ch3[50];
                        sprintf(ch3,"l'unité %d attaque l'unité %d",num_unite_attaque,num_unite_attaquante_nouvelle);
                        texte = TTF_RenderText_Blended(font,ch3,blanc);
                        positionText.x=615;
                        positionText.y=240;
                        SDL_BlitSurface(texte, NULL, ec, &positionText);
            ...
            // afficherPlateauBataille(ec,numJoueurEnnemi,numJoueur,plateauBataille,unitesBataille,type);
             SDL_BlitSurface(menu, NULL, ec, &positionMenu);
             char *ch6[50];
             sprintf(ch6,"selection de l'unité à attaquer %d",num_unite_attaquante);
         ...
         // affiche_attaque_ennemie(ec,num_unite_attaque,num_unite_attaquante,numJoueur,numJoueurEnnemi,unitesBataille,attaquer,contre);
          ...
          SDL_BlitSurface(menu, NULL, ec, &positionMenu);
          char *ch7[50];
          sprintf(ch7,"l'unité %d attaque l'unité %d",num_unite_attaque,num_unite_attaquante);
       ...
       case SDL_MOUSEBUTTONDOWN:
            ...
            { int x_clicked=event.button.x;
              int y_clicked=event.button.y;
                ...
                char *ch2[50];
                sprintf(ch2,"Le joueur %d a gagné la bataille",joueur_enemie);
                texte = TTF_RenderText_Blended(font,ch2,blanc);
                positionText.x =190;
                positionText.y =350;
                SDL_BlitSurface(texte, NULL, ec, &positionText);
       ...
       SDL_WaitEvent(&event);
        ...
        case SDLK_ESCAPE:
            ...
            break;
                ...
                char *ch[50];
                sprintf(ch,"L'ennemie %d à été déja attaqué",num_enemie);
   ...
   while (continuer==1)
    {
        ...
        if(font != 0)
        {
            char* phrase[1];
            char *ch[10];
            sprintf(ch,"Mettre L'héro %d principal",x+1);
            phrase[0]= "OUI";
            phrase[1]= "NON";
            int i, y_depart=489;
            SDL_Color couleur_a_utiliser;
        ...
        case SDL_MOUSEBUTTONDOWN:
         ...
         case SDL_KEYDOWN:
                ...
                while(nbr_heros!=liste_heros)
            {
                ...
                char ch[100]="Configuration Héros";
...
void  config_hero(SDL_Surface*ec, int joueurs[NB_LIGNES_JOUEURS][NB_COLONNES_JOUEURS],
 ...
 int herosJoueurs[NB_LIGNES_HEROSJOUEURS][NB_COLONNES_HEROSJOUEURS]){
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            char ch[50]="configuration Héros";
            char* phrase[nombre_phrase];
            phrase[0]= "  Mettre un nouveau héro comme principal   ";
            phrase[1]= "  Revenir au menu précédent                ";
   ...
   while (continuer==1)
    {
      ...
      char* phrase[liste_unite];
        ...
        {
            char* phrase[1];
            char ch1[50]="Activation de l'unité";
            phrase[0]= "OUI";
            phrase[1]= "NON";
            int i, y_depart=485;
            SDL_Color couleur_a_utiliser;
   ...
   while (continuer==1)
    {
      ...
      char* phrase[liste_unite];
        ...
        {
            char* phrase[1];
            char ch1[50]="Mettre l'unité en reserve ";
            phrase[0]= "OUI";
            phrase[1]= "NON";
            int i, y_depart=485;
            SDL_Color couleur_a_utiliser;
    ...
    {   SDL_BlitSurface(menu, NULL, ec, &positionMenu);
       SDL_WaitEvent(&event);
        ...
        case SDLK_ESCAPE:
          ...
          char *ch[50];
          sprintf(ch,"Activation de l'unité %d annulée",x);
          char ch1[50]="Tous les emplacements sont occupés !";
...
int nombre_phrase=3;
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            ...
            char* phrase[nombre_phrase];
            phrase[0]= "  configuration héros         ";
            phrase[1]= "  configuration unités        ";
            phrase[2]= "  Revenir au menu précédent   ";
            int i, y_depart=230, y_depart_titre=80;
            SDL_Color couleur_a_utiliser;
            for(i=0; i<nombre_phrase; i++)
            {
...
int nombre_phrase=2;
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            char ch[50]="Achat Unités";
            char* phrase[nombre_phrase];
            phrase[0]= "  Acheter des nouvelles unités ";
            phrase[1]= "  Revenir au menu précédent    ";
            int i, y_depart=230, y_depart_titre=80;
            SDL_Color couleur_a_utiliser;
              for(i=0; i<nombre_phrase; i++)
...
void  acheter_hero( SDL_Surface *ec,int joueurs[NB_LIGNES_JOUEURS][NB_COLONNES_JOUEURS],
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            char ch[50]="Achat Héros";
            char* phrase[nombre_phrase];
            phrase[0]= "  Acheter un nouveau héro        ";
            phrase[1]= "  Revenir au menu précédent      ";
            int i, y_depart=230, y_depart_titre=80;
            SDL_Color couleur_a_utiliser;
                for(i=0; i<nombre_phrase; i++)
   ...
   while (continuer==1)
    {
           ...
           if(font != 0)
        {
            char* conf[1];
            char* ch1[50];
            sprintf(ch1,"L'achat héro  %d",x+1);
            conf[0]= "OUI";
            conf[1]= "NON";
            int i, y_depart=510;
            SDL_Color couleur_a_utiliser;
...
int unitesJoueurs[NB_LIGNES_UNITESJOUEURS][NB_COLONNES_UNITESJOUEURS]){
    ...
    while (continuer==1)
    {
        ...
        if(font != 0)
        {
            char ch[50]="Magasin";
            char* phrase[nombre_phrase];
            phrase[0]= "      Acheter des héros         ";
            phrase[1]= "      Acheter des unités        ";
            phrase[2]= "      Revenir au menu précédent ";
